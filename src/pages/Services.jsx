    ...
    <section>
      ...
      <div className="cardContainer">
        <div className="card">
          ...
          <p>I create responsive and user-friendly websites using modern web 
        ...
        <div className="card">
          ...
          <p>I design and develop Java-based applications using object-oriented programming 
            principles. This includes creating classes, implementing inheritance, managing data, 
            and solving real-world programming problems. </p>
        </div>

        <div className="card">
          
          <h2>Database Design and Management </h2>
          <p>I work with SQL and database systems to design, create, and manage databases. 
