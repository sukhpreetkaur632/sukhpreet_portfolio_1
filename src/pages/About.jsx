// Imports the profile image and resume file used on this page
...
function About() {
  return (
    <section>
      ...
      {/* Holds the profile image and personal information side by side */}
      <div className="aboutLayout">
        ...
        <div className="infoCard">
          ...
          <p>
            ...
            user experiences.
            <br></br>
            Currently, I am expanding my skills in HTML, CSS, JavaScript, React,
            Java, SQL, and database management. Through my academic projects and
            personal practice, I have gained experience in designing websites,
            developing interactive user interfaces, and implementing programming
